...
use App\Utility\Pool\MysqlAllPool;
...
class EasySwooleEvent implements Event
{
    ...
    public static function initialize()
    {
         ...
         * Mysql协程连接池
         */
        PoolManager::getInstance()->register(MysqlAllPool::class, Config::getInstance()->getConf('MYSQL.POOL_MAX_NUM'));
         ...
         * MONGO协程连接池
         */
        $mongoConf = PoolManager::getInstance()->register(MongoPool::class, Config::getInstance()->getConf('MONGO.POOL_MAX_NUM'));
        //$mysqlConf->setMinObjectNum(2);
