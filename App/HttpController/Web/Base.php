...
class Base extends Controller
{
     ...
     * @param  array  $vars
     */
    function tpRender($template, array $vars = [])
    {
        $vars = array_merge($vars,['domain'=>'http://admin-es.mitrade3.com/report']);
        $this->response()->write(Render::getInstance()->render($template,$vars));
    }
